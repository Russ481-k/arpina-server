...
public abstract class CustomBaseException extends RuntimeException {
    ...
    private final String detailMessage; // Optional: For additional details not meant for direct user display but for logging
    ...
    // Constructor to add more detailed information, e.g. for logging or specific cases
    ...
    public CustomBaseException(String customMessage, ErrorCode errorCode, HttpStatus httpStatus, String detailMessage, Throwable cause) {
        super(customMessage, cause);
        this.errorCode = errorCode;
        this.httpStatus = httpStatus;
        this.detailMessage = detailMessage;
