...
public interface BbsArticleRepository extends JpaRepository<BbsArticleDomain, Long> {
    ...
    @NonNull
    Page<BbsArticleDomain> findByBbsIdAndMenuId(@Param("bbsId") Long bbsId, @Param("menuId") Long menuId, @NonNull Pageable pageable);
    ...
    Page<BbsArticleDomain> findRootArticlesByBbsIdAndMenuId(@Param("bbsId") Long bbsId, @Param("menuId") Long menuId, Pageable pageable);
    ...
    Page<BbsArticleDomain> findRepliesByParentNttId(@Param("bbsId") Long bbsId, @Param("parentNttId") Long parentNttId, Pageable pageable);
    ...
    Page<BbsArticleDomain> searchByKeywordAndMenuId(@Param("bbsId") Long bbsId, @Param("menuId") Long menuId, @Param("keyword") String keyword, Pageable pageable);
    ...
    long countByBbsIdAndMenuIdAndNoticeStateNot(@Param("bbsId") Long bbsId, @Param("menuId") Long menuId, @Param("noticeState") String noticeState);
    ...
    long countByBbsIdAndMenuIdAndKeywordAndNoticeStateNot(@Param("bbsId") Long bbsId, @Param("menuId") Long menuId, @Param("keyword") String keyword, @Param("noticeState") String noticeState);
} 